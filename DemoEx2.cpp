...
int main()
{
    ...
    cout << g4; // Should print the matrix of the graph: [0, 1, 0], [1, 0, 1], [0, 1, 0]
    cout << g1;
    if (g4 == g1) // its true
    {
        std::cout << "the matrix equel" << std::endl;
    }
    cout << g2;
    ariel::Graph g5 = g1 * g2; // Multiply the two graphs together.
    cout << g5;                // Should print the multiplication of the matrices of g1 and g2: [0, 0, 2], [1, 0, 1], [1, 0, 0]
    //  ariel::Graph g12 = g4 * g2; // multiplying matrices of different sizes
